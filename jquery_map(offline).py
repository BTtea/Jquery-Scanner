...
def check_similarity(target_url:str,target_res_text:str,find_ver:list) -> None:
    ...
    for ver in find_ver:
        ...
        for path in version_key[ver]:
            ...
            if not os.path.exists('all_version_jquery'):
                os.makedirs('all_version_jquery')
    ...
    if len(param)==3:
        ...
        if action=='html':
            ...
            if platform_system() == "Windows":
                ...
                html_scanner='data:text/html;base64,'
                os.system(f'start {browser} "{html_scanner}"')
            else:
                os.system(f'BROWSER=$(xdg-settings get default-web-browser | sed \'s/\.desktop$//\');$BROWSER "{html_scanner}"')
